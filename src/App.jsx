function App() {
  return (
    <div className="bg-red-100 min-h-screen">
      <header className="bg-blue-100 h-96 md:h-20">
        <div className="max-w-screen-xl mx-auto h-full flex justify-between items-center">
          <div>YongHyuk's Portfolio</div>
          <ul className="flex gap-2 md:gap-8 text-xs sm:texd-sm md:text-base">
